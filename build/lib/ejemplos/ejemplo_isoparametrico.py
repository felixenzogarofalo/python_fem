...
"""
import numpy as np
from elementos.isoparametrico_cuad import Isoparametrico_Cuad
...
poisson = 0.25                  # Coeficiente de poisson

# Crear los elementos
ele_1 = Isoparametrico_Cuad(1, 1, 2, 3, 4, [3, 2], [5, 2], [5, 4], [3, 4], t, E, poisson)
