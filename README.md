...
## Módulo 1 â€“ TeorÃ­a y programación básica de elementos finitos
En este primer mÃ³dulo estableceremos los fundamentos que nos permitirán entender el método de los elementos finitos. Daremos atención a las bases matemáticas y repasaremos criterios de mecánica de materiales. Sin embargo, nos enfocaremos en lo que debemos tener en cuenta desde el punto de vista de su aplicación en ingenierí­a y no solo desde su planteamiento matemático. Veremos la aplicabilidad del método, asÃ­ como los conceptos mÃ¡s bÃ¡sicos que deben ser asimilados. De forma paralela presentaremos la solución computacional de los planteamientos teÃóicos que incluirá la programación de las ecuaciones. Lo que nos dará un entendimiento más profundo del método.
